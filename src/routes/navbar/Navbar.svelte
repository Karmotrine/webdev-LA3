...
<Navbar let:hidden let:toggle class="!bg-[#D24646]">
    <NavBrand href="/">
        <img
            src="/images/infinity music logo.png"
    ...
    <NavUl {hidden}>
        <NavLi href="/" class="text-black font-semibold">Home</NavLi>
        <NavLi href="/about" class="text-black font-semibold">About</NavLi>
    </NavUl>
</Navbar>