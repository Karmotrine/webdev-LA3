...
<Footer footerType="socialmedia">
  ...
  <div class="sm:flex sm:items-center sm:justify-between">
      <FooterCopyright href="/" by="BSCS 3-1 Web Development Group 7" aClass="!text-gray-500" />
      <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <FooterIcon href="https://github.com/Karmotrine/webdev-LA3.git" class="text-gray-400 hover:text-gray-900">
